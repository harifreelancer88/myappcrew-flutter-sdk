...
class TesterIdentityStore {
  ...
  static const _keyRefreshToken = 'myappcrew_connected_refresh_token';
  ...
  Future<void> saveIdentity(TesterIdentity identity) async {
    try {
      ...
      if (identity.refreshToken != null &&
          identity.refreshToken!.isNotEmpty) {
        await prefs.setString(_keyRefreshToken, identity.refreshToken!);
      } else {
